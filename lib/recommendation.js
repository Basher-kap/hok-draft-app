...
// off-role matchups), and now team synergy (picks - community-curated
// combos of heroes that work well together).
//
...
// suggestible.
//
// Still NOT factored in: real win/pick/ban-rate stats, damage-type/CC
// balance. Counter/synergy data has real gaps (not every hero has
// evidence) - heroes without it simply get zero bonus, never penalized
// or guessed at.
...
export function scorePickCandidate(hero, { filledLanes, algorithmMode, comfortLevel, enemyPickEntries, teamPickEntries }) {
  ...
  return { hero, score: tierScore + gapBonus + comfortBonus + counterBonus + synergyBonus, reasons };
}
