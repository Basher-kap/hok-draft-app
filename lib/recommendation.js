...
// topN: how many ranked results to return - defaults to ALL available heroes
export function getSuggestions({ availableHeroes, phase, teamPicks, enemyPicks, algorithmMode, getComfortLevel, topN = Infinity }) {
  if (phase === "ban") {
