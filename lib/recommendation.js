...
// Rank Draft's ban-phase scorer - blends tier with real ranked-ladder
// ban/win/pick rate, when available. Distinct from
// scoreTournamentBanCandidate on purpose: that one bans off pro/
// tournament-scene relevance, this one bans off what's actually dominant
// on the ranked ladder right now - the two metas can and do diverge.
