...
// hero hot list: https://camp.honorofkings.com/h5/app/index.html?lang_type=en#/hero-hot-list
// This is deliberately separate from Tournament Draft's data (which is
// pro/tournament-scene stats, e.g. HoK World Cup - see project notes).
// The two modes intentionally see different "what's worth banning" data,
// since the ranked ladder meta and the pro meta often diverge a lot.
//
// Ranked-ladder meta stats (Rank Draft only) - sourced from HOK Camp's
// official hero hot list, via HoKStats.gg's mirror (server-rendered, so
// it can actually be fetched/read - the raw HOK Camp page is a JS SPA):
